...
- `2.1.0-rc.10` enthält einen ausdrücklich manuellen Notweg für historische 0-%-Kleinunternehmerbelege, die der aktuelle sevDesk-Mandant nicht mehr mit Rule 11 fertigstellen kann. Er ist nur im bestätigten Altbestandsformular erreichbar, erzeugt ausschließlich bezahlte EUR-Voucher mit positiven 0-%-Positionen, Rule 17 und einem frisch durch `ReceiptGuidance` bestätigten `REVENUE`-Konto und versendet keine Mail. Guthaben, Sammelzahlungen, Rabatte, AddFunds, Late Fees, Fremdwährungen und Belege außerhalb des festen Kleinunternehmerzeitraums bleiben gesperrt. Die Kontierung ist ausdrücklich vorläufig und muss vor jeder sevDesk-Auswertung oder Abgabe manuell berichtigt werden; der normale Tax-Resolver bleibt unverändert.
