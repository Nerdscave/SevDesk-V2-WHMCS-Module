...
final class Config
{
    ...
    private const DEFAULTS = [
        ...
        'late_fee_accounting_source' => 'rule22_voucher',
        ...
        'sevdesk_reminder_subject' => 'Zahlungserinnerung zu {invoice_number}',
        'sevdesk_reminder_body' => "Guten Tag,\n\nbitte beachten Sie die offene Rechnung {invoice_number}.",
        'sevdesk_cancellation_subject' => 'Stornorechnung zu {invoice_number}',
        'sevdesk_cancellation_body' => "Guten Tag,\n\nim Anhang finden Sie die Stornorechnung zu {invoice_number}.",
